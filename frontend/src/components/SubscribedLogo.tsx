...
const SubscribedLogo = () => {
    ...
    const subscriptionEndAt = subscriptionData?.getUserSubscription?.endAt ?? null;
    const formattedSubscriptionEndAt = subscriptionEndAt ? new Date(subscriptionEndAt).toLocaleDateString() : "";
    ...
    return (
        <Popover>
            ...
            <PopoverContent side="left" align="center" className="w-fit p-3 bg-cyan-100 dark:bg-cyan-800 dark:text-white">
                <div>
                    {subscriptionLoading ? (
                        <p>Chargement...</p>
                    ) : (
